...
<head>
  ...
  <!-- Main styles -->
  <link href="<?=base_url('assets/vendor')?>/css/admin.css" rel="stylesheet">
  <!-- Icon fonts-->
  <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
  <!-- Plugin styles -->
  <link href="<?=base_url('assets/vendor')?>/css/dataTables.bootstrap4.css" rel="stylesheet">
  <!-- CK Editor -->
  <script src="https://cdn.ckeditor.com/4.12.1/standard/ckeditor.js"></script>
  <!-- Your custom styles -->
  <link href="<?=base_url('assets/vendor')?>/css/custom.css" rel="stylesheet">
...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html"><img src="<?=base_url('assets/vendor')?>/img/logo.png" data-retina="true" alt="" width="163" height="36"></a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Master">
          ...
          <ul class="sidenav-second-level collapse" id="master">
			...
			<li>
              <a href="<?=base_url('lession')?>">Lession</a>
            </li>
            <li>
